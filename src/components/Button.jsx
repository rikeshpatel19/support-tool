const Button = ({ children, onClick, variant = 'primary', className = '' }) => {
  ...
  const variants = {
    ...
    q_select: "text-md p-4 w-5 h-5 rounded-md hover:bg-(--hover)",
    ...
    themed: "bg-(--primary) text-white font-bold py-3 px-6 rounded-xl shadow-hard active:translate-y-1 active:shadow-none"
  };
